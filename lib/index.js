...
App.prototype.configureRoutes = function() {
  ...
  // Wire up the client routes
  this.app.use(express['static'](this.options.client.staticPath));
  this.app.get('/room/:id', authenticate, this.options.client.handleRequest);
};
