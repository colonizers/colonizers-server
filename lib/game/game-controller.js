...
function GameController(game, emitter) {
  this.game = game;
...
GameController.prototype.pushEvent = function(options, callback) {
  var logger,
      req;
...
GameController.prototype.distributeResources = function(req, diceTotal) {
  ...
  req.addEvent('DistributeResources', data);
  req.done();
};
